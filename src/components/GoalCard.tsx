  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex flex-col h-full relative overflow-hidden group hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center gap-3 mb-6 relative">
        ...
        <div>
          <h3 className="text-sm font-semibold text-indigo-600 tracking-wide uppercase">Current Goal</h3>
          <h2 className="text-xl font-bold text-gray-900 mt-0.5 leading-tight">Finish Bachelor Thesis</h2>
        </div>
      </div>
      ...
      <div className="space-y-4 flex-grow flex flex-col justify-end relative">
        <div className="flex justify-between items-end mb-2">
          <span className="text-4xl font-extrabold text-gray-900 tracking-tighter">
            {progress}<span className="text-2xl text-gray-400 font-bold">%</span>
          </span>
          <span className="text-sm font-medium text-gray-500 flex items-center gap-1.5 bg-gray-50 px-2.5 py-1 rounded-lg border border-gray-100">
